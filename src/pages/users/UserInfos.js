        ...
        return (
            <Form onSubmit={submitLogin}>
                ...
                <Modal.Body>
                    ...
                    <Form.Control required name={"oldPassword"} min={8} onChange={changeInputs}
        ...
        return (
            <Form onSubmit={submitParol}>
                ...
                <Modal.Body>
                    ...
                    <Form.Control required name={"newPassword1"} min={8} onChange={changeInputs}
                                  value={state.newPassword1}/>
                    <Form.Label>Yangi parolni takroran kiriting</Form.Label>
                    <Form.Control required name={"newPassword2"} min={8} onChange={changeInputs}
