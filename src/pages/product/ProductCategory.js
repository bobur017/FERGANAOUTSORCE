...
function ProductCategory() {
    ...
    return (
        <div className={'allMain'}>
            <NavbarHeader name={"Mahsulot turlari bo'limi"} handleShow={() => handleShow(1)}
                          buttonName={"Mahsulot_turini qo'shish"}/>
                                ...
                                <tr key={index}>
                                    ...
                                    <td>
                                        <Button variant='outline-info' size='sm'
                                                onClick={() => onClickProductCategory(item, 1)}>
                                            O'zgartirish
                                        </Button>
                                    </td>
                                    <td>
                                        <Button variant='outline-danger' size='sm'
                                                onClick={() => onClickProductCategory(item, 2)}>
                                            O'chirish
                                        </Button>
                                    </td>
                                </tr>
            ...
            <Modal show={show} onHide={handleClose}>
                <Form onSubmit={submitProductCategory}>
                    ...
                    <Modal.Body>
                        <Form.Control name='name' required value={productCategoryState.name}
